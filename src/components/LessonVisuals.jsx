...
export function HoldemHero() {
  return (
    <VisualFrame caption="Two private cards (yours) + five shared community cards = the seven cards you build your hand from.">
      <div style={{
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: 4, justifyContent: "center" }}>
            <TritonCard card="As" size={62}/>
            <TritonCard card="Kh" size={62}/>
          </div>
        </div>
        {/* Community cards */}
        <div style={{ textAlign: "center" }}>
          <SmallLabel>Community cards</SmallLabel>
          <div style={{ display: "flex", gap: 4, justifyContent: "center", flexWrap: "wrap" }}>
            <TritonCard card="Qc" size={62}/>
            <TritonCard card="Jd" size={62}/>
            <TritonCard card="Th" size={62}/>
            <TritonCard card="4s" size={62}/>
            <TritonCard card="7c" size={62}/>
          </div>
        </div>
      </div>
    </VisualFrame>
  ...
  const boards = [
    {
      ...
      cards: ["Kh", "9h", "4h"],
      threat: "Three hearts — anyone with one more heart makes a flush. Worry if a fourth heart comes.",
    },
    {
      title: "Straight draw board",
      cards: ["Tc", "9d", "8s"],
      threat: "Three connected ranks (8-9-T) — JQ, 76, J7, Q-J all complete straights or strong draws.",
    },
    {
      title: "Paired board",
      cards: ["7s", "7d", "Kc"],
      threat: "Two sevens on board — anyone with a third 7 has trips, anyone with KK now has a full house.",
    },
  ];
  return (
        ...
        {boards.map(b => (
          <div key={b.title}>
            ...
            <div style={{ display: "flex", gap: 4, marginBottom: 6, flexWrap: "wrap" }}>
              {b.cards.map((c, i) => <TritonCard key={i} card={c} size={50}/>)}
            </div>
