  ...
  // ────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { type: "visual", visual: "showdown-example", props: {
        ...
        board: [],
        heroLabel: "Pair (≈53%)",
        oppLabel: "Two overcards (≈47%)",
        heroHand: "Pocket Fives",
        oppHand: "Ace-King offsuit",
        caption: "A classic coinflip: the small pair is a tiny favorite, but it's close to 50-50. With dead money in the pot, getting it in here is routinely profitable.",
      }},
