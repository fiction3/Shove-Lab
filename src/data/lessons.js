...
export const LESSONS = [
  ...
  // ────────────────────────────────────────────────────────────────
  {
    id: "pot-odds",
    title: "Pot Odds",
    subtitle: "The price the pot is offering you",
    estimatedMinutes: 5,
    sections: [
      { type: "prose", text: "Pot odds answer one question: how often does my call need to win to break even? If the answer is 25% and your hand wins more than 25% of the time, you should call. Less than 25%, you should fold. That's the entire game in one sentence." },
      { type: "heading", text: "The calculation" },
      { type: "prose", text: "Required equity = the amount you need to call ÷ (the pot after you call). The pot \"after you call\" includes the original pot plus your call." },
      { type: "example", title: "Worked example", body: "The pot is 8bb. Villain bets 4bb. You face a 4bb call into what is now a 12bb pot. After you call, the pot will be 16bb. Required equity = 4 / 16 = 25%. You need to win the hand at showdown more than 25% of the time, given villain's range, to make calling +EV." },
      { type: "heading", text: "Why people mess this up" },
      { type: "prose", text: "Two common mistakes. First: forgetting to include your call in the denominator (gets you the wrong percentage). Second: comparing your equity to villain's specific hand instead of their range. You're never up against one hand — you're up against the distribution of hands they'd play this way." },
      { type: "heading", text: "Mental shortcut" },
      { type: "prose", text: "Memorize the common ones. Half-pot bet = 25% equity to call. Pot-sized bet = 33%. 2x pot bet (rare) = 40%. Quarter-pot bet = 17%. Most pot odds calculations in real play snap to one of these shapes." },
    ],
