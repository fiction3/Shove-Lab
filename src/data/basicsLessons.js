...
export const BASICS_LESSONS = [
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { type: "prose", text: "You hold King-Queen, and the five shared cards include another King and another Queen. That gives you two pair. Your opponent has just a single pair of Kings. You win — because two pair beats one pair." },
      { type: "visual", visual: "showdown-example", props: {
        hero: ["Ks", "Qs"],
        opp: ["Kc", "9d"],
        board: ["Kh", "Qd", "7c", "4s", "2h"],
        heroHand: "Two pair — Kings & Queens",
        oppHand: "One pair — Kings",
        winner: "hero",
        note: "Both players have a pair of Kings from the board, but you also pair your Queen — two pair beats one pair, so you win.",
        caption: "Your two private cards combine with the five shared cards to make your best five-card hand.",
      }},
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { type: "heading", text: "Example flop" },
      { type: "prose", text: "You hold King-Queen. The flop comes King, 7, 2. You now have a pair of Kings, because your King pairs with the King on the board. Decent hand — you'd usually keep playing." },
      { type: "visual", visual: "showdown-example", props: {
        hero: ["Ks", "Qd"],
        board: ["Kh", "7c", "2s"],
        heroHand: "Pair of Kings",
        boardLabel: "The flop (first 3 shared cards)",
        caption: "Your K pairs with the K on the flop — that's a pair of Kings.",
      }},
      ...
      { type: "prose", text: "Say the turn brings a Queen. Now your King-Queen has improved — you've made two pair, Kings and Queens. Your hand just got a lot stronger." },
      { type: "visual", visual: "showdown-example", props: {
        hero: ["Ks", "Qd"],
        board: ["Kh", "7c", "2s", "Qh"],
        heroHand: "Two pair — Kings & Queens",
        boardLabel: "The turn (4th shared card added)",
        caption: "The Queen pairs your other card — your pair of Kings is now two pair.",
      }},
      ...
      { type: "prose", text: "The river is a 3. It doesn't help your hand, but it doesn't matter — you still have your two pair, Kings and Queens, and that's a strong hand to go to showdown with." },
      { type: "visual", visual: "showdown-example", props: {
        hero: ["Ks", "Qd"],
        board: ["Kh", "7c", "2s", "Qh", "3d"],
        heroHand: "Two pair — Kings & Queens",
        boardLabel: "The river (all 5 shared cards)",
        caption: "Your final five-card hand: two pair, Kings and Queens.",
      }},
      ...
      { type: "prose", text: "Suppose your opponent shows a single pair of Kings. Your two pair beats their one pair — you win the pot." },
      { type: "visual", visual: "showdown-example", props: {
        hero: ["Ks", "Qd"],
        opp: ["Kc", "9s"],
        board: ["Kh", "7c", "2s", "Qh", "3d"],
        ...
        oppHand: "One pair — Kings",
        winner: "hero",
        note: "You both share the King on the board, but your Queen makes two pair — and two pair beats one pair.",
        caption: "At showdown, both players reveal and the best five-card hand takes the pot.",
      }},
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { type: "visual", visual: "showdown-example", props: {
        ...
        boardLabel: "The board — what's possible here?",
        note: "Straights are possible (someone with T-J, J-T, 6-T, or 5-6 would have one). A flush is NOT possible — only two hearts, you'd need three. A full house is NOT possible — no pair on the board. So the biggest threat to watch for is a straight.",
        caption: "Before betting, scan the board for what strong hands it could give an opponent.",
      }},
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { type: "visual", visual: "showdown-example", props: {
        hero: ["7d", "2c"],
        board: [],
        heroHand: "The worst starting hand — and it can still win",
        heroLabel: "You",
        boardLabel: "Your hole cards",
        caption: "7-2 offsuit is the weakest hand in Hold'em. But if everyone folds to your bet, the pot is yours — your cards never even get shown.",
      }},
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { type: "visual", visual: "hand-trio", props: {
        ...
        caption: "Hands like these look playable to a beginner but quietly lose money over time — especially from early position. When in doubt, fold.",
      }},
      ...
      { type: "visual", visual: "showdown-example", props: {
        hero: ["8s", "8h"],
        board: ["8d", "Kc", "3h"],
        heroHand: "A set of Eights (three of a kind)",
        heroLabel: "You",
        boardLabel: "The flop",
        caption: "You hold a pair of Eights and the flop brings a third — that's a set, a very strong hand. Don't get cute and check it; bet and build the pot while you're ahead.",
      }},
